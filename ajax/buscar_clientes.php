...
if (isset($_GET['id'])) {
    ...
    <?php }
        ...
        <div class="alert alert-danger alert-dismissible" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <strong>Error!</strong> No se pudo eliminar éste cliente. Existen facturas vinculadas a éste cliente.
        </div>
<?php }
}
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            while ($row = mysqli_fetch_array($query)) {
                ...
                $cuil_cuit         = $row['cuil_cuit_cliente'];
                ...
                <input type="hidden" value="<?php echo $cuil_cuit; ?>" id="cuil_cuit<?php echo $id_cliente; ?>">
                ...
                <tr>
                    ...
                    <td><span class="pull-right">
                            <a href="#" class='btn btn-success' title='Editar cliente' onclick="obtener_datos('<?php echo $id_cliente; ?>');"
                                data-toggle="modal" data-target="#myModalEditClient"><i class="glyphicon glyphicon-edit"></i></a>
