...
function paginate($reload, $page, $tpages, $adjacents) {
	...
	if($page==1) {
		...
		$out.= '<li><span class="pagination_arrow"><a href="javascript:void(0);" onclick="load(1)">$prevlabel</a></span></li>';
	}else {
		$out.= '<li><span class="pagination_arrow"><a href="javascript:void(0);" onclick="load('.($page-1).')">$prevlabel</a></span></li>';
