        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" role="form" id="datos_factura">
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control input-sm" id="nombre_cliente" placeholder="Selecciona un cliente"
                            required value="<?php echo $nombre_cliente; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input type="text" size="10" class="form-control input-sm" id="fecha" name="fecha" value="<?php echo $fecha_factura; ?>">
                    </div>
...
<script>
    ...
    $("#nombre_cliente").on("keydown", function (event) {
        if (event.keyCode == $.ui.keyCode.LEFT || event.keyCode == $.ui.keyCode.RIGHT || event.keyCode == $
            .ui.keyCode.UP || event.keyCode == $.ui.keyCode.DOWN || event.keyCode == $.ui.keyCode.DELETE ||
